...
def process_order_files():
    ...
    df1 = pd.read_parquet('../Data Source/enterprise_department/order_with_merchant_data1.parquet')
    ...
    df2 = pd.read_parquet('../Data Source/enterprise_department/order_with_merchant_data2.parquet')
    ...
    df3 = pd.read_csv('../Data Source/enterprise_department/order_with_merchant_data3.csv')
...
def process_merchant_data():
    df_list = pd.read_html('../Data Source/enterprise_department/merchant_data.html') 
    df = df_list[0] 
...
def process_staff_data():
    df_list = pd.read_html('../Data Source/enterprise_department/staff_data.html')  
    df = df_list[0]
