...
# File paths
user_credit_card_path = base_dir / 'Data Source' / 'customer_management_department' / 'user_credit_card.pickle'
user_data_path = base_dir / 'Data Source' / 'customer_management_department' / 'user_data.json'
user_job_path = base_dir / 'Data Source' / 'customer_management_department' / 'user_job.csv'

cleaned_user_credit_card_path = base_dir / 'et_customer_management_department' / 'Cleaned Data' / 'cleaned_user_credit_card.csv'
cleaned_user_data_path = base_dir / 'et_customer_management_department' / 'Cleaned Data' / 'cleaned_user_data.csv'
cleaned_user_job_path = base_dir / 'et_customer_management_department' / 'Cleaned Data' / 'cleaned_user_job.csv'
